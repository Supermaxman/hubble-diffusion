...
archive_url = "https://esahubble.org/static/archives/images/original/"
...
class NasaImageSpider(scrapy.Spider):
    name = "nasaspider"
    start_urls = [
        f"https://esahubble.org/images/archive/search/page/{i}/"
        # filtered by "observations" and by "fine" quality & minimum resolution "400x300"
        "?ranking=20&minimum_size=1&type=Observation"
        for i in range(1, 44)
    ]
    custom_settings = {
